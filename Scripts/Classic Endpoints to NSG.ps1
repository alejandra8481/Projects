...
#Docs
## https://docs.microsoft.com/en-us/azure/virtual-network/virtual-networks-acl-powershell
        ...
        foreach($endpoint in $endpoints){
            ...
            if($endpoint.Acl.Count -gt 0){
                ...
                foreach($acl in $acls){
                    ...
                    if($ActionType -match "permit"){$ActionType = "Allow"}
                ...
                # https://docs.microsoft.com/en-us/azure/virtual-network/virtual-networks-acl#how-acls-work
